...
public class Student_Subject_Registration_Adapter extends BaseExpandableListAdapter {
    private List<ExpandedSubjectData> groupitem;
    Context mContext;
    ImageView down, up;
    private ArrayList<UserType> arrayList;
    Student_Next_Registation fragment;
    CheckBox checkBox;
    HashMap<String, String> mCheckBoxData;

    public Student_Subject_Registration_Adapter(List<ExpandedSubjectData> groupitem, Context mContext, Student_Next_Registation fragment,HashMap<String, String> checkBoxData_1) {
