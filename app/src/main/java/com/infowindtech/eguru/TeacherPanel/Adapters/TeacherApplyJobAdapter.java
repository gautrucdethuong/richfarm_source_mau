...
public class TeacherApplyJobAdapter extends BaseAdapter{
    private List<ClassInfoData> mListenerList;
    Context mContext;
    ApplyJobListitemBinding binding;

    public TeacherApplyJobAdapter(List<ClassInfoData> mListenerList, Context mContext) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup){
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("from","Applyjob");
